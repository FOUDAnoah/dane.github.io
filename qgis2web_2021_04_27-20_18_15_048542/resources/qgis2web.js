...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32632',
            extent: [661704.999807, 615315.624325, 685110.812369, 641040.686838],
            units: 'm'})
    })
});
...
map.getView().fit([657210.607804, 614167.331451, 692535.164166, 641343.690145], map.getSize());
